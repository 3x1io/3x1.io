<div class="group mx-4 border-gray-200 relative border bg-white dark:bg-black/20 dark:border-slate-800 rounded-xl overflow-hidden">
    ...
    <div class="p-4">
        <div class="flex items-center justify-between space-x-8 text-base font-medium">
            <h3>
                <a href="{{ url(app()->getLocale() .'/'. $url) }}" title="{{ $label }}" aria-label="{{ $label }}" class="font-display text-xl text-black dark:text-gray-200">
